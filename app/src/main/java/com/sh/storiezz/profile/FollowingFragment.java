...
public class FollowingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainView = inflater.inflate(R.layout.fragment_following, container, false);

        mAuth = FirebaseAuth.getInstance();
        mCurrentUserId = mAuth.getCurrentUser().getUid();
        mFollowerDatabaseReference = FirebaseDatabase.getInstance().getReference().child(Const.DB_REF_FOLLOWING).child(mCurrentUserId);
        ...
        mFollowerList = (RecyclerView) mMainView.findViewById(R.id.fragment_following_list);
    ...
    public void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Following,FollowingFragment.FollowingViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Following,FollowingFragment.FollowingViewHolder>(
                Following.class,
                R.layout.users_single_layout,
                FollowingFragment.FollowingViewHolder.class,
                mFollowerDatabaseReference
        ) {

            @Override
            protected void populateViewHolder(final FollowingFragment.FollowingViewHolder viewHolder, final Following model, int position) {
